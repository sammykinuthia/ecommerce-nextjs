    ...
    return (
        <div className=" ">
            <div className="border-accent p-4 border rounded-3xl ">
                <Image width={400} height={600} alt="Daily Essential" className={"w-60"} src={"https://media.istockphoto.com/id/119401613/photo/fruit-basket.jpg?s=612x612&w=0&k=20&c=_puYLZkRaT7Ki-Lls5hnSadDZlm_knimpV0RgAL6_tY="}/>
            </div>
            <div className="my-4" >
